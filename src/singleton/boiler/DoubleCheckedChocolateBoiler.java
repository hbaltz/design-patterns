...
public class DoubleCheckedChocolateBoiler {
    ...
    /**
     * The volatile keyword ensures that multiple threads handle this variable correctly when it is being initialized
     * to the DoubleCheckedChocolateBoiler instance
     */
    private volatile static DoubleCheckedChocolateBoiler chocolateBoilerUniqInstance = null;
    ...
    public static DoubleCheckedChocolateBoiler getInstance() {
        ...
        if (chocolateBoilerUniqInstance == null) {
            ...
            synchronized (DoubleCheckedChocolateBoiler.class) {
                chocolateBoilerUniqInstance = new DoubleCheckedChocolateBoiler();
            }
        }
